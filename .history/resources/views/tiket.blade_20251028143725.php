...
<body>
    ...
    <div class="container">
        <div class="ticket-card">
            ...
            <div class="ticket-left">
                <div class="image-placeholder-large" onclick="changeImage(this)">🏖️</div>
            ...
            <div class="ticket-right">
                <div>
                    <div class="ticket-header-text">
                        ...
                        <h1 class="ticket-subtitle" id="destination-title">Bali Paradise Beach</h1>
                    </div>
                    ...
                    <div class="ticket-details">
                        <div class="detail-item" onclick="changeDetail(this)">
                            ...
                            <div class="detail-value">Bali Paradise Beach</div>
                        </div>
                        ...
                        <div class="detail-item" onclick="changeDetail(this)">
                            ...
                            <div class="detail-value">15 Des 2023</div>
                        </div>
                ...
                <div>
                    <div class="price-section">
                        <div class="price-info">
                            ...
                            <div class="price-value">Rp 150.000</div>
                        </div>
    ...
    <script>
        ...
        function changeImage(element) {
            ...
            // Update destination title based on image
            const titles = {
                '🏖️': 'Bali Paradise Beach',
                '🏞️': 'Taman Nasional Bromo',
                '🏰': 'Candi Borobudur',
                '⛰️': 'Raja Ampat Dive',
                '🏕️': 'Danau Toba Camping',
                '🗼': 'Monas Jakarta Tour'
            };
            
            document.getElementById('destination-title').textContent = titles[newImage];
        }
